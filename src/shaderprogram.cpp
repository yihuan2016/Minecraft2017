...
void ShaderProgram::setupTexture(){
    if(unifSampler !=-1){
        ...
        int w,h;
        unsigned char* image = SOIL_load_image("/Users/Groverchen/Downloads/minecraft_textures_all/minecraft_textures_all.png", &w, &h, 0, SOIL_LOAD_RGB);
...
void ShaderProgram::setupNorMap(){
    if(unifNormal !=-1){
        ...
        int w,h;
        unsigned char* image = SOIL_load_image("/Users/Groverchen/Downloads/minecraft_textures_all/minecraft_normals_all.png", &w, &h, 0, SOIL_LOAD_RGB);
